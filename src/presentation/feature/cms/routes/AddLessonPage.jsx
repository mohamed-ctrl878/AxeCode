...
/**
 * AddLessonPage: Dedicated route page for creating a lesson inside a week.
 * Route: /cms/courses/:courseId/weeks/:weekId/add-lesson
 */
export const AddLessonPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error('[AddLessonPage] Creation failed:', err);
        }
    };

    const isSubmitting = inProgress || isUploading;
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="border border-border-subtle rounded-3xl md:rounded-[2.5rem] overflow-hidden min-h-[300px] md:min-h-[350px] bg-surface-sunken/40 focus-within:border-accent-primary focus-within:bg-surface-sunken transition-all shadow-inner">
                                <RichTextInput
                                    ...
                                    placeholder="Draft the lesson content here..."
                                />
                            </div>
                        </div>
