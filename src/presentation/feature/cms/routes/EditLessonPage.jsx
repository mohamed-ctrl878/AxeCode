                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="px-2 py-0.5 rounded text-[10px] font-black bg-accent-blue/10 border border-accent-blue/20 text-accent-blue uppercase tracking-widest mt-1">Refining</span>
                        </div>
                ...
                <div className="lg:col-span-8 space-y-10">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <div className="border border-border-subtle rounded-[2.5rem] overflow-hidden min-h-[400px] bg-surface-sunken/40 focus-within:border-accent-blue focus-within:bg-surface-sunken transition-all shadow-inner">
                                <RichTextInput
                                    value={description}
                                ...
                                <div className="relative rounded-[3rem] overflow-hidden aspect-video bg-black border border-border-default group shadow-2xl">
                                    {videoPreview ? (
                                        ...
                                        <div className="w-full h-full flex flex-col items-center justify-center bg-accent-blue/10 relative">
                                            ...
                                            <div className="w-24 h-24 rounded-full bg-accent-blue/20 flex items-center justify-center text-accent-blue mb-6 animate-pulse shadow-xl">
                                                <Play size={40} />
                                            </div>
                                            <span className="text-lg text-accent-blue font-black tracking-tight italic">Active Protocol Asset Loaded</span>
