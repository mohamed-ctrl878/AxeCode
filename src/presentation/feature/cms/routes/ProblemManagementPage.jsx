                ...
                <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                        <div className="flex flex-wrap items-center gap-4">
                            <h1 className="text-3xl font-black italic tracking-tighter text-text-primary">Problem Architect</h1>
                            <span className="px-3 py-1 rounded-xl text-[10px] font-black border border-accent-primary/20 bg-accent-primary/10 text-accent-primary uppercase tracking-[0.2em] mt-1 shadow-whisper">PROTOCOL ID: {id}</span>
                        </div>
                        <p className="text-text-muted text-[10px] font-black uppercase tracking-[0.2em] mt-2 opacity-40">Manage technical signatures, validation tiers, and solution archetypes.</p>
                    </div>
                </div>
