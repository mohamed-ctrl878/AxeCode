 ...
 */
export const CreatePost = ({ className }) => {
    return (
        <div className={cn(
            ...
            <div className="flex items-center gap-4">
                ...
                />
                <button className="bg-white text-black px-6 py-2 rounded-full font-medium hover:scale-105 transition-transform duration-300 flex items-center gap-2">
                    <Send size={16} />
                    <span>Create</span>
                </button>
            </div>
